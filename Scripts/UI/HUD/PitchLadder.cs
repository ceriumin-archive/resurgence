...
public class PitchLadder : MonoBehaviour {
    ...
    [Header("References")]
    [SerializeField] private GameObject pitchHorizonPrefab;
    [SerializeField] private GameObject pitchPositivePrefab;
    [SerializeField] private GameObject pitchNegativePrefab;

    [Header("Settings")]
    [SerializeField] private int barInterval;
